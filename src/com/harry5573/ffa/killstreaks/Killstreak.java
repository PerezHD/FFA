        ...
        if ((e instanceof Player) && (plugin.killstreak.containsKey((Player) e))) {
            ...
            if (killer != null) {
                ...
                if (newx == 1) {
                    ...
                    Bukkit.broadcastMessage(plugin.prefix + ChatColor.DARK_RED + " " + killer.getName() + ChatColor.GRAY + " Is on a " + ChatColor.AQUA + newx + ChatColor.GRAY + " killstreak and has recived " + ChatColor.LIGHT_PURPLE + "$500");
                } else if (newx == 12) {
                    ...
                    killer.playSound(killer.getLocation(), Sound.GHAST_SCREAM, 5.0F, 1.0F);
                    Bukkit.broadcastMessage(plugin.prefix + ChatColor.DARK_RED + " " + killer.getName() + ChatColor.GRAY + " Is on a" + ChatColor.AQUA + " 24 " + ChatColor.GRAY + "killstreak and has recived " + ChatColor.LIGHT_PURPLE + "$5000 " + ChatColor.GRAY + " + " + ChatColor.LIGHT_PURPLE + "New Armour" + ChatColor.GRAY + " + " + ChatColor.LIGHT_PURPLE + "Strength");
                    plugin.ih.giveArmour(killer);
                    ...
                    killer.playSound(killer.getLocation(), Sound.GHAST_SCREAM, 5.0F, 1.0F);
                    Bukkit.broadcastMessage(plugin.prefix + ChatColor.DARK_RED + " " + killer.getName() + ChatColor.GRAY + " Is on a" + ChatColor.AQUA + " 36 " + ChatColor.GRAY + "killstreak and has recived " + ChatColor.LIGHT_PURPLE + "$7500     " + ChatColor.GRAY + " + " + ChatColor.LIGHT_PURPLE + "New Armour" + ChatColor.GRAY + " + " + ChatColor.DARK_RED + "Regeneration");
                    plugin.ih.giveArmour(killer);
